...
export default function Contact() {
  ...
  return (
    <main className="bg-[#0c111D] h-screen flex justify-center items-center content-center flex-col gap-y-1">
      ...
      <div id="dropdownSearch" className="z-10 bg-[#0c111D] rounded-lg shadow w-60 border border-gray-500">
        ...
        <ul className="h-48 px-3 pb-3 overflow-y-auto text-sm text-gray-100 " >
          ...
          <li key={index}>
            <div className="flex items-center ps-2 rounded hover:bg-gray-100 hover:text-gray-800">
